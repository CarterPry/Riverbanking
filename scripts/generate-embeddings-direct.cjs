...
const attacks = [
  // Enumeration attacks - should run first
  { id: 'subdomain-enumeration', name: 'Subdomain Enumeration', description: 'Discover all subdomains for comprehensive testing' },
  { id: 'directory-discovery', name: 'Directory and File Discovery', description: 'Find hidden directories, backup files, and sensitive information' },
  { id: 'api-discovery', name: 'API Endpoint Discovery', description: 'Enumerate API endpoints and methods' },
  { id: 'jwt-testing', name: 'JWT Token Security Testing', description: 'Test JWT tokens for algorithm confusion, weak secrets, and signature vulnerabilities' },
